	...
	class WC_Vindi_API {
		...
		public function getPaymentMethods() {
			...
			if ( false === ( $paymentMethods = get_transient( 'vindi_payment_methods' ) ) ) {
                ...
                set_transient( 'vindi_payment_methods', $paymentMethods, 1 * HOUR_IN_SECONDS );
			}
        ...
        public function testApiKey($apiKey)
        {
            ...
            $method    = 'GET';
			$requestId = rand();
            $dataToLog = 'API Authorization Test';
            ...
            if ( isset( $responseBodyArray['errors'] ) && ! empty( $responseBodyArray['errors'] ) ) {
